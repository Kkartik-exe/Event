    ...
    <div id="top" className="Whole_div" style={{ backgroundImage: `url(${pattern})` }}>
      ...
      <Container fluid>
        ...
        <Row className="prizesection non-coding" id="themes">
          <PrizeHeading type="Tech-Storm Themes" />
          <ThemeType />
        </Row>

         {/*TimeLine Section*/}
         <Row className="timeline" id="timeline">
        <PrizeHeading type="Events TimeLine" />
          <TimeLine />
        </Row>
        ...
        <div class="row1-container">
          ...
          <div class="box red">
            <h2>First</h2><img class="imgright" src="https://img.icons8.com/emoji/96/000000/1st-place-medal-emoji.png" alt="" />
            <h4><b>Prize</b>:In Process<br />Swags & Promo Codes<br /><br /><a href="">Load More</a></h4>
          </div>

          <div class="box box-down cyan">
            <h2>Second</h2><img className="imgright" src="https://img.icons8.com/emoji/96/000000/2nd-place-medal-emoji.png" alt="" />
            <h4><b>Prize</b>: In Process <br />Swags & Promo Codes<br /><br /><a href=""zz>Load More</a></h4>
          </div>

          <div class="box box-down blue">
            <h2>Third</h2><img class="imgright" src="https://img.icons8.com/emoji/96/000000/3rd-place-medal-emoji.png" alt="" />
            <h4><b>Prize</b>: In Process<br />Swags & Promo Codes<br /><br /><a href="link">Load More</a></h4>
          </div>
        </div>
        ...
        <div class="row1-container margfromsponsor">
          ...
          <div class="box color1">
            <h2>Best IEEE Team</h2><img class="imgright" src="https://img.icons8.com/emoji/96/000000/sports-medal-emoji.png" alt="" />
            <h4><b>Prize</b>:In Process <br />Swags & Promo Codes<br /><br /><a href="">Load More</a></h4>
          </div>
        ...
        <Row className="sponsorSection" id="sponsors">
          <SponsorsHead />
          <h1 className="">Presentations</h1>
          <br />
          {titlesponsorLogos.map(SponsorGroup)}
          <br /><br />
          <h1 className="">Video Visulization</h1>
          <br />
          {goldsponsorLogos.map(SponsorGroup)}
          <br /><br />
          <h1 className="">Artistic</h1>
          <br />
          {silversponsorLogos.map(SponsorGroup)}
          <br /><br />
          <h1 className="">Other Events</h1>
          <br />
          {bronzeponsorLogos.map(SponsorGroup)}
          <br /><br />
          {/* <SponsorUS /> */}<br /><br />
          <h1 className="">Sponsors Of Event</h1>
          <br />
